...
> Design notes for **nonprofit-donor-receipt-pdf** — a runnable typescript example that Typed TypeScript service for generating nonprofit donor receipt PDFs.
...
- **Feature code** — the actual task: donor receipts.
